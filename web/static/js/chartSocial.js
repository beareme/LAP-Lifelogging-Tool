var Chart = (function(window,d3) {
  ...
  d3.csv('static/data/lastMonthSocial.csv', init); //load data, then initialize chart
  ...
  function render() {
    ...
    updateDimensions(document.getElementById("social").offsetWidth - 16*2);    
    ...
    path.attr('d', line).attr('style','stroke: #2743ba;');
    //renderLabels();
  }
/*
  var labels = [
