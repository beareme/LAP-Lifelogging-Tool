var Chart = (function(window,d3) {
  ...
  d3.csv('static/data/lastMonthEat.csv', init); //load data, then initialize chart
  ...
  function render() {
    ...
    updateDimensions(document.getElementById("eat").offsetWidth - 16*2);    
    ...
    path.attr('d', line).attr('style','stroke: #b54343;');
    //renderLabels();
  }
/*
  var labels = [
